...
class SpellParserTest {
    ...
    @Test
    void splitRetainsConfigurableChildCount() throws Exception {
    ...
    void rejectsInvalidModifiersAndSplitCounts() {
        ...
        assertThrows(SpellValidationException.class, () -> SpellParser.parse("BOLT SPLIT"));
    }
    ...
    void programRoundTripsThroughManifestationNbt() throws Exception {
        SpellProgram original = SpellParser.parse("BOLT HOME SPLIT(3) LINK IMPACT IGNITE");
